...
import net.ersei.dml.compat.rei.itemStack
import net.ersei.dml.item.ITEM_SOOT_REDSTONE
...
class CrushingDisplayCategory: DisplayCategory<CrushingRecipeDisplay> {
    ...
    override fun getTitle(): MutableText = TranslatableText("rei.${MOD_ID}.category.crushing")
