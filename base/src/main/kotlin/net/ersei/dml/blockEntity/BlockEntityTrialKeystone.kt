            ...
            if (world?.isClient == false && blockEntity.currentTrial == null) {
                blockEntity.trialToLoad?.let { trialToLoad ->
                    try {
                        ...
                        net.ersei.dml.LOGGER.error("Failed to load trial at $pos: ${e.message}")
                    }
