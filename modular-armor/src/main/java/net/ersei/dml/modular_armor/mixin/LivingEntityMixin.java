...
import net.ersei.dml.item.ItemEmeritusHat;
import net.ersei.dml.modular_armor.EntityStatusEffectsKt;
import net.ersei.dml.modular_armor.ItemModularGlitchArmor;
import net.ersei.dml.modular_armor.effects.RotResistanceEffect;
import net.ersei.dml.modular_armor.effects.TargetCancellationEffect;
import net.ersei.dml.modular_armor.effects.UndyingEffect;
